...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/backoffice/logout": Record<string, never>;
		...
		Pathname(): "/" | "/admin" | "/admin/callback" | "/admin/messages" | "/admin/reservations" | "/admin/reservations/nouvelle" | `/admin/reservations/${string}` & {} | "/api/auth/callback" | "/api/auth/token" | "/api/calendar" | "/api/calendar/callback" | "/api/calendar/public" | "/api/test" | "/backoffice" | "/backoffice/login" | "/backoffice/logout" | "/calendar" | "/contact" | `/gite/${string}` & {} | "/login" | "/test-api";
