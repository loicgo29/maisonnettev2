...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/callback" | "/admin/messages" | "/admin/reservations" | "/admin/reservations/nouvelle" | "/admin/reservations/[id]" | "/api" | "/api/auth" | "/api/auth/callback" | "/api/auth/token" | "/api/calendar" | "/api/calendar/callback" | "/api/calendar/public" | "/api/test" | "/backoffice" | "/backoffice/login" | "/backoffice/meals" | "/calendar" | "/contact" | "/gite" | "/gite/[slug]" | "/test-api";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/api/calendar/public": Record<string, never>;
			"/api/test": Record<string, never>;
			"/backoffice": Record<string, never>;
			"/backoffice/login": Record<string, never>;
			"/backoffice/meals": Record<string, never>;
		...
		Pathname(): "/" | "/admin" | "/admin/callback" | "/admin/messages" | "/admin/reservations" | "/admin/reservations/nouvelle" | `/admin/reservations/${string}` & {} | "/api/auth/callback" | "/api/auth/token" | "/api/calendar" | "/api/calendar/callback" | "/api/calendar/public" | "/api/test" | "/backoffice/login" | "/backoffice/meals" | "/calendar" | "/contact" | `/gite/${string}` & {} | "/test-api";
