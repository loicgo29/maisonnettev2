#!/usr/bin/env python3
"""Migrate expense_category enum to include 'divers'."""
...
def migrate():
    db = SessionLocal()
    try:
        print("Starting migration: adding 'divers' to expense_category enum...")
        ...
        print("Creating new expenses table with 'divers' category...")
        db.execute(text("""
